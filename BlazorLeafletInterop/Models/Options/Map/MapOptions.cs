...
public class MapOptions : LayerOptions
{
    ...
    public IJSObjectReference[] Layers { get; set; } = Array.Empty<IJSObjectReference>();
    public IJSObjectReference? MaxBounds { get; set; } = null;
    public IJSObjectReference? Renderer { get; set; } = null;
